...
2. Ejecuta `git status --short`, `git diff` y comprobaciones dirigidas; usa `git diff --check` cuando aporte valor.
...
5. En la documentación o la memoria, valida la coherencia, la brevedad y la ausencia de datos privados solo si esos archivos han cambiado.
6. Reporta evidencia, validaciones no ejecutadas y riesgo residual. No inventes resultados ni corrijas problemas ajenos.
